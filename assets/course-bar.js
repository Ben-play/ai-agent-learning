...
(function() {
  ...
  const LESSONS = [
    ...
    { file: '0004-L01-dev-environment-setup.html', title: '开发环境搭建', phase: '第一阶段', min: 55 },
    { file: '0005-L02-python-runtime-and-modules.html', title: 'Python 运行机制与模块系统', phase: '第一阶段', min: 65 },
    { file: '0006-L03-variables-types-data-structures.html', title: '变量、类型与数据结构', phase: '第一阶段', min: 45 },
    { file: '0008-L04-control-flow-and-prompt.html', title: '流程控制、字符串与 Prompt 构造', phase: '第一阶段', min: 60 },
    { file: '0009-L05-functions-and-parameters.html', title: '函数定义与参数', phase: '第一阶段', min: 45 },
    { file: '0010-L06-scope-closures-lambda.html', title: '作用域、闭包与 Lambda', phase: '第一阶段', min: 20 },
    { file: '0011-L07-classes-and-dataclass.html', title: '类、对象与 @dataclass', phase: '第一阶段', min: 35 },
    ...
    { file: '0015-L11-decorators.html', title: '装饰器', phase: '第一阶段', min: 50 },
    { file: '0016-L12-generators-streaming.html', title: '生成器与 Streaming', phase: '第一阶段', min: 40 },
    { file: '0017-L13-type-hints.html', title: '类型提示系统', phase: '第一阶段', min: 20 },
    { file: '0018-L14-pydantic.html', title: 'Pydantic 数据验证', phase: '第一阶段', min: 45 },
    { file: '0019-L15-httpx.html', title: '用 httpx 发起 HTTP 请求', phase: '第一阶段', min: 30 },
    { file: '0020-L16-async-concurrency.html', title: 'async/await 与并发', phase: '第一阶段', min: 40 },
    { file: '0029-phase2-ai-knowledge-outline.html', title: '第二阶段大纲', phase: '' },
    { file: '0021-L17-llm-essence-and-parameters.html', title: 'LLM 本质与生成参数', phase: '第二阶段', min: 45 },
    { file: '0022-L18-tokenization.html', title: 'Token 与 Tokenization', phase: '第二阶段', min: 60 },
    { file: '0023-L19-hallucination.html', title: '幻觉全解（多因素视角）', phase: '第二阶段', min: 55 },
    { file: '0024-L20-reasoning-models.html', title: '推理能力与 Adaptive Thinking', phase: '第二阶段', min: 45 },
    { file: '0025-L21-model-capabilities.html', title: '模型能力边界与 Base vs Instruct', phase: '第二阶段', min: 60 },
    { file: '0026-L22-benchmarks-and-selection.html', title: '看懂 Benchmark 与模型选型', phase: '第二阶段', min: 60 },
    { file: '0027-L23-token-economics.html', title: 'Token 经济学与降本杠杆', phase: '第二阶段', min: 60 },
