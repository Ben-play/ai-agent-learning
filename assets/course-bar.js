...
(function() {
  ...
  const LESSONS = [
    ...
    { file: '0013-L09-files-json-dict.html', title: '文件、JSON 与 Dict 深度操作', phase: '第一阶段', min: 20 },
    { file: '0014-L10-exceptions-logging-context.html', title: '异常处理、日志与上下文管理器', phase: '第一阶段', min: 25 },
    { file: '0015-L11-decorators.html', title: '装饰器', phase: '第一阶段', min: 25 },
    { file: '0016-L12-generators-streaming.html', title: '生成器与 Streaming', phase: '第一阶段', min: 20 },
    { file: '0017-L13-type-hints.html', title: '类型提示系统', phase: '第一阶段', min: 20 },
    { file: '0018-L14-pydantic.html', title: 'Pydantic 数据验证', phase: '第一阶段', min: 25 },
    { file: '0019-L15-httpx.html', title: '用 httpx 发起 HTTP 请求', phase: '第一阶段', min: 25 },
    { file: '0020-L16-async-concurrency.html', title: 'async/await 与并发', phase: '第一阶段', min: 20 },
    { file: '0021-L17-llm-essence-and-parameters.html', title: 'LLM 本质与生成参数', phase: '第二阶段', min: 15 },
    { file: '0022-L18-tokenization.html', title: 'Token 与 Tokenization', phase: '第二阶段', min: 15 },
    { file: '0023-L19-hallucination.html', title: '幻觉全解（校准视角）', phase: '第二阶段', min: 25 },
    { file: '0024-L20-reasoning-models.html', title: '推理模型与 Extended Thinking', phase: '第二阶段', min: 45 },
    { file: '0025-L21-model-capabilities.html', title: '模型能力边界与 Base vs Instruct', phase: '第二阶段', min: 25 },
    { file: '0026-L22-benchmarks-and-selection.html', title: '看懂 Benchmark 与模型选型', phase: '第二阶段', min: 30 },
    { file: '0027-L23-token-economics.html', title: 'Token 经济学与降本杠杆', phase: '第二阶段', min: 30 },
    { file: '0028-L24-phase2-capstone.html', title: 'Phase 2 综合实战项目', phase: '第二阶段', min: 40 },
